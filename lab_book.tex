...
\newsubexperiment{DataTypes}[Data Types in FEniCS]{Be carefule with data types in FEniCS}
...
Figured out some things about \fenics data types...
...
Possible way of interfacing a C++ file with \fenics\ldots

%-----------------------------------------

\subexperiment{Jacobians}

Derived Jacobians for reaction terms\ldots
